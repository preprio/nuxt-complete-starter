        ...
        <div class="items-center pt-6 pb-5 px-7 md:grid md:grid-cols-2">
          <div>
            ...
            <div class="my-2 article">
              This preview will reflect any content changes. You may clone this
          ...
          <div>
            <div>
              <a
                href="https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fpreprio%2Fpatterns&env=PREPR_ACCESS_TOKEN,PREPR_API_ENDPOINT&envDescription=Your%20Prepr%20Access%20token.%20Found%20in%20Settings%20%3E%20Access%20Tokens.&envLink=https%3A%2F%2Fdocs.prepr.io%2Freference%2Fgraphql%2Fv1%2Fauthorization&project-name=prepr-patterns&repository-name=prepr-patterns&demo-title=Prepr%20Patterns&demo-description=Clone%20the%20Nuxt%20project%20to%20start%20working%20on%20your%20front-end.&demo-url=https%3A%2F%2Fpatterns.prepr.io%2Fpage-pattern&demo-image=https%3A%2F%2Fassets-site.prepr.io%2F%2F19pw7mgmcc89-patterns-preview.png"
                target="_blank"
...
showBanner.value = token.value !== config.public.PREPR_ACCESS_TOKEN;

const resetToken = async () => {
  token.value = config.public.PREPR_ACCESS_TOKEN;
  showBanner.value = false;
  router.replace({ query: { token: config.public.PREPR_ACCESS_TOKEN } });
