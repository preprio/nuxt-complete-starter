    ...
    <div class="rounded-xl bg-gray-50">
      <div class="px-8 py-7">
        ...
        <div class="relative">
          ...
          >
            <span
              v-html="state.selectedSegment.label"
            ></span>
            <svg
          ...
          >
            ...
            >
              <li v-for="segment in segments">
                <a
                    v-if="segment.isSegment"
                    href="."
                    key="segment.value"
                    @click.prevent="emitSegment(segment.value)"
...
const props = defineProps({ title: String, type: String, currentSegment: String });
...
watch(
    ...
    (newValue) => {
      state.selectedSegment = segments.find((segment) => segment.value === newValue)
    }
);
const segments = [
  {
...
const state = reactive({
  selectedSegment: segments.find((segment) => segment.value === props.currentSegment)
});
